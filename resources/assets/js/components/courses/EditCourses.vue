    ...
    <div>
        <modal name="myModal" :draggable="true" :scrollable="true" @before-open="beforeOpen" :adaptive="true" height="auto">
            ...
            <div class="page-title">
                ...
                <span class="col-md-2"><img :src="'/images/'+data.image" class="doctor-pic" alt=""> <br>{{data.name}}</span>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" v-model="data.course_code" class="form-control" :disabled=!enabled>
                    </div>
                    <div class="form-group">
                        <label for="">Unit </label>
                        <input type="text" v-model="data.unit" class="form-control" :disabled=!enabled>
                    </div>
                    <div class="form-group">
                        <label for="">Professor</label>
                        <select name="" id="" v-model="data.professor_id" :disabled=!enabled class="form-control">
                            <option>Professor</option>
                            <option value="" v-for="professor in professors" :value="professor.id">
                                                ...
                                                <div class="card-body ">
                                                    <div class="table-scrollable">
                                                        <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
                                                            ...
                                                            <tbody>
                                                            <tr class="odd gradeX" v-for="(course, index) in courses">
                                                                ...
                                                                <td class="left">1 Semester</td>
                                                                <td>
                                                                    <a class="btn btn-primary btn-xs" id="modal_launcher" @click="launch(course)">
                ...
                axios.post('/course/edit', course)
                    .then(response => {
                        ...
                        if (_response.status === 0){
                            ...
                            this.$notify({type: 'error', text: '<span style="color: white">Updating Course\'s info. unsuccessfully. Try again later</span>', speed:400});
                        }
                    })
                    .catch(error =>{
                        this.$notify({type: 'error', text: '<span style="color: white">Updating Course\'s info. unsuccessfully. Try again later</span>', speed:400});
